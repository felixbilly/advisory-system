...
<head>
  ...
  <title>courseadvisory.com</title>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="home.php"><span> ONLINE COURSE ADVISORY</span></a>
      </div>
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="home.php">General Advisory</a></li>
          <li><a href="home.php">Personal Advisory</a></li>
          <li><a href="home.php">Contuct ust</a></li>
          <li><a href="home.php">Help</a></li>
<!--
...
<form action="userprofile.php" method="get">
    <button type="submit"  class="links"><span class="glyphicon glyphicon-user"></span> Profile
...
<form action="usersuggestion.php" method="get">
    <button type="submit"  class="links"><span class="glyphicon glyphicon-bullhorn"></span>Question and Answers
<?php
...
<form action="userratingpage.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-signal"></span>Rate the service</button>
</form>
<form action="chat2.php" method="get">
        <button type="submit"  class="links"><span class="glyphicon glyphicon-envelope"></span>Chat with advisor</button>
</form>
